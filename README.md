...
4. Now login using the ssh. Type: ```ssh -i ~/.ssh/<keyname> grader@3.120.182.168``` or ```ssh grader@3.120.182.168```

## Server Details
- IP address : 3.120.182.168
- SSH PORT : 2200
- HOSTED APPLICATION URL : http://3.120.182.168/
- Passphrase : udacity
